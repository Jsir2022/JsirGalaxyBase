...
public final class TerminalBankSectionSnapshot {
    ...
    public TerminalBankSectionSnapshot(AccountStatus accountStatus, BalanceSummary balanceSummary,
        TransferForm transferForm, ActionFeedback actionFeedback, List<String> playerLedgerLines) {
        this.accountStatus = accountStatus == null ? AccountStatus.placeholder() : accountStatus;
        this.balanceSummary = balanceSummary == null ? BalanceSummary.placeholder() : balanceSummary;
        this.transferForm = transferForm == null ? TransferForm.placeholder() : transferForm;
    ...
    public static TerminalBankSectionSnapshot placeholder() {
        return new TerminalBankSectionSnapshot(
            AccountStatus.placeholder(),
            BalanceSummary.placeholder(),
            TransferForm.placeholder(),
    ...
    public static final class AccountStatus {
        ...
        public AccountStatus(boolean opened, String serviceState, String accountLabel, String playerStatus,
        ...
        public static AccountStatus placeholder() {
            return new AccountStatus(false, "银行 section 宿主已接入", "未开户", "当前暂无账户状态。", "未分配", "无更新记录", true);
        }
    ...
    public static final class BalanceSummary {
        ...
        public BalanceSummary(String playerBalance, String exchangeBalance, String exchangeStatus,
        ...
        public static BalanceSummary placeholder() {
            return new BalanceSummary("未开户", "不可用", "公开账户未就绪", "后续银行摘要会显示在这里。", false);
        }
    ...
    public static final class TransferForm {
        ...
        public TransferForm(String targetPlayerName, String amountText, String comment, boolean transferEnabled) {
        ...
        public static TransferForm placeholder() {
            return new TransferForm("", "", "", false);
        }
    ...
    public static final class ActionFeedback {
        ...
        public static ActionFeedback placeholder() {
            return new ActionFeedback("银行动作反馈", "开户、刷新与转账反馈会显示在这里。", TerminalNotificationSeverity.INFO.name());
        }
