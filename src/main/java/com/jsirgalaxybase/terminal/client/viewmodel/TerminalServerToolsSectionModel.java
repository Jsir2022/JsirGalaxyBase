...
public final class TerminalServerToolsSectionModel {
    ...
    public TerminalServerToolsSectionModel(String serviceState, String currentServerId,
    ...
    public TerminalServerToolsSectionModel(String serviceState, String currentServerId,
        ...
        String recentSourceServerId, String recentTargetServerId, String recentTransferStatus,
        String recentTransferTime, String recentTransferSummary, ActionFeedbackModel actionFeedback) {
        this(serviceState, currentServerId, serverLines, serverIds, warpLines, warpNames, warpSubtitles,
    ...
    public static TerminalServerToolsSectionModel placeholder() {
    ...
    public static final class ActionFeedbackModel {
        ...
        public static ActionFeedbackModel placeholder() {
            return new ActionFeedbackModel("传送动作反馈", "当前没有传送动作反馈。", TerminalNotificationSeverity.INFO.name());
        }
