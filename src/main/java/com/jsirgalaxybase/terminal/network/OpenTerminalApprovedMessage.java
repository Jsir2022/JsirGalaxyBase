...
public class OpenTerminalApprovedMessage implements IMessage {
    ...
    static com.jsirgalaxybase.terminal.TerminalQuestCenterSectionSnapshot readQuestCenter(ByteBuf buf) {
        ...
        return new com.jsirgalaxybase.terminal.TerminalQuestCenterSectionSnapshot(service,message,view,chapterId,questId,filter,query,chapters,chapterPage,chapterSize,chapterTotal,quests,questPage,questSize,questTotal,detail,management,chapterManagement);
    }
